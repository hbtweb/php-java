 ...
 *
 * Source: javap signature of java.time.chrono.ChronoLocalDateTime. Regenerate via
 *   php tools/gen-aot-stubs.php java.time.chrono.ChronoLocalDateTime
 */
interface ChronoLocalDateTime
{
    ...
    public function toInstant($a0 = null);
    public function toEpochSecond($a0 = null);
